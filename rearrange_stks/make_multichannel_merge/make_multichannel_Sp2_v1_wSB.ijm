...
function combine_images(data_dir,save_dir,keyword_C1,keyword_C2,keyword_C3,keyword_C4,px_size,sb_size) {
	...
	for (i=0; i<lengthOf(basename_list); i++) {
		...
		//C6 (magenta);
		//C7 (yellow);
		//run("Merge Channels...", "c3=C2 c6=C3 create keep");
		//rename("merge");
...
function main(){
	...
	keyword_C1 = "_w22    spinning  DAPI";
	keyword_C2 = "_w32    spinning  GFP";
	keyword_C3 = "_w42    spinning  mCherry";
	keyword_C4 = "_w52    spinning  Cy5";
	...
	save_dir = data_dir + "tiff/";
	//save_dir = getDirectory("Choose Save Directory");
	//File.makeDirectory(save_dir);

	combine_images(data_dir,save_dir,keyword_C1,keyword_C2,keyword_C3,keyword_C4,px_size,sb_size);
