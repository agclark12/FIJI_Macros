...
function autocrop_hstk(channel_to_reg){
	...
	start_slice = find_first_min_intensity(mean_int_list_norm,0.1) + 1;
	Array.reverse(mean_int_list_norm);
	end_slice = lengthOf(mean_int_list_norm) - find_first_min_intensity(mean_int_list_norm,0.1);
